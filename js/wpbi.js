    ...
    jQuery('#charttype').change(function () {
        ...
        if(jQuery('#charttype option:selected').text() !== "Select your chart type")
        {
            exampletext.append('<h4>' + jQuery('#charttype option:selected').text() +
                ' example file</h4><p>This is an example file for the selected chart type: <a href="/wp-content/plugins/tera-charts-pro/charts/files/examples/' + filename + '.xlsx">' + filename + '.xlsx</p>');
        }
